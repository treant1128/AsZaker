package org.treant.laucher.util;

import org.treant.laucher.R;

public class Data {
	public static int ItemCount = 8;
	public static String[] Items_text = { "应用推荐", "美女美图", "星座星缘", "财经天下", "头条新闻",
			"天天创意", "娱乐八卦", "大名人" };
	...
	public static String[] Item0 = { "冷笑话精选", "一日一美女", "我的微博","爱约会美女","头条新闻","美女时钟"};
	//public static String[] Item0 = { "创意工厂", "头条新闻", "冷笑话精选","财经网","电影工厂","用户中心"};
