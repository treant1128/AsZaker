package org.treant.laucher;

import java.io.File;
import java.util.ArrayList;
import org.treant.laucher.additem.AddItemActivity;
import org.treant.laucher.database.LaucherDataBase;
import org.treant.laucher.databean.ContentItem;
import org.treant.laucher.myanimations.MyAnimations;
import org.treant.laucher.myview.DragGridView;
import org.treant.laucher.myview.ScrollLayout;
import org.treant.laucher.path.AboutActivity;
import org.treant.laucher.path.FeedbackActivity;
import org.treant.laucher.path.HelpActivity;
import org.treant.laucher.path.SetActivity;
import org.treant.laucher.util.Configure;
import org.treant.laucher.util.FileOperation;
...
public class MiLaucherActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(lstDate.size()==0)
			Toast.makeText(MiLaucherActivity.this, "请检查网络连接", 1500).show();
		init();
		initData();
		initPath();
	...
	public void runAnimation() {
		...
		right.setDuration(12000);
		left.setDuration(12000);
